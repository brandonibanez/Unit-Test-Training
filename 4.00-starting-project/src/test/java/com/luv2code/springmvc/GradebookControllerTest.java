...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("emailAddress", "rabby@test.com");
    }
    ...
    public void getStudentHttpRequest() throws Exception {
        ...
        student.setFirstname("Shobby");
        student.setLastname("Robby");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        student.setFirstname("Shobby");
        student.setLastname("Robby");
        student.setEmailAddress("shobby@gmail.com");
    ...
    public void studentInformationHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 1))
                ...
                .andExpect(jsonPath("$.firstname", is("Rabby")))
                .andExpect(jsonPath("$.lastname", is("Dabby")))
                .andExpect(jsonPath("$.emailAddress", is("test@test.com")));
    }
