...
public class StudentAndGradeServiceTest {
    ...
    public void studentInformationService() {
        ...
        assertEquals("Rabby", gradebookCollegeStudentTest.getFirstname());
        assertEquals("Dabby", gradebookCollegeStudentTest.getLastname());
        assertEquals("test@test.com", gradebookCollegeStudentTest.getEmailAddress());
