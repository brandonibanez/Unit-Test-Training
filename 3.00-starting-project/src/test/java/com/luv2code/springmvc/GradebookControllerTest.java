...
public class GradebookControllerTest {
    ...
    public void getStudentsHttpRequest() throws Exception {
        CollegeStudent studentOne = new GradebookCollegeStudent("Rabby", "Dabby",
                        "test@gmail.com");
        CollegeStudent studentTwo = new GradebookCollegeStudent("Rabby2", "Dabby22",
                "test2@gmail.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent studentOne = new CollegeStudent("Shobby", "Dobby",
                "test@gmail.com");
